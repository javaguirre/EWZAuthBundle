...
class TwitterService extends Service
{
    ...
    public function getLoginUrl($next, $cancel, array $parameters = array())
    {
        ...
        $this->session->set('oauth/twitter/request/oauth_token', $requestToken['oauth_token']);
        $this->session->set('oauth/twitter/request/oauth_token_secret', $requestToken['oauth_token_secret']);
    ...
    public function getProfile()
    {
        try {
            ...
            if ($this->session->get('oauth/twitter/request/oauth_token') !== $this->request->query->get('oauth_token')) {
                $this->session->remove('oauth/twitter/request/oauth_token');
                $this->session->remove('oauth/twitter/request/oauth_token_secret');
            ...
            $this->twitter->setTokens(
                $this->session->get('oauth/twitter/request/oauth_token'),
                $this->session->get('oauth/twitter/request/oauth_token_secret')
            );
            ...
            $this->session->set('oauth/twitter/access/oauth_token', $accessToken['oauth_token']);
            $this->session->set('oauth/twitter/access/oauth_token_secret', $accessToken['oauth_token_secret']);
            ...
            $this->twitter->setTokens(
                $this->session->get('oauth/twitter/access/oauth_token'),
                $this->session->get('oauth/twitter/access/oauth_token_secret')
            );
    ...
    protected function cleanSession()
    {
        $this->session->remove('oauth/twitter/request/oauth_token');
        $this->session->remove('oauth/twitter/request/oauth_token_secret');
        $this->session->remove('oauth/twitter/access/oauth_token');
        $this->session->remove('oauth/twitter/access/oauth_token_secret');
    }
